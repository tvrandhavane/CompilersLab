...
void Machine_Description::initialize_instruction_table()
{
	...
	spim_instruction_table[move_op] = new Instruction_Descriptor(move_op, "move", "move", "", i_r_op_o1, a_op_r_o1);

	spim_instruction_table[label] = new Instruction_Descriptor(label, "label", "label", "", i_op_o1, a_op_o1);

	spim_instruction_table[sgt] = new Instruction_Descriptor(sgt, "sgt", "sgt", "", i_r_o1_op_o2, a_op_o1_o2_r);
	spim_instruction_table[slt] = new Instruction_Descriptor(slt, "slt", "slt", "", i_r_o1_op_o2, a_op_o1_o2_r);
	spim_instruction_table[sge] = new Instruction_Descriptor(sge, "sge", "sge", "", i_r_o1_op_o2, a_op_o1_o2_r);
	spim_instruction_table[sle] = new Instruction_Descriptor(sle, "sle", "sle", "", i_r_o1_op_o2, a_op_o1_o2_r);
