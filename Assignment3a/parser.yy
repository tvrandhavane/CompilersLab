...
%token RETURN INTEGER IF ELSE GOTO ASSIGN_OP FLOAT FLOAT_NUMBER DOUBLE
%left MULT_OP DIV_OP
%left ADD_OP SUB_OP
%left ne eq
%left lt le gt ge
...
|
	variable_or_constant_typecast ADD_OP arithmetic_expression
	{

	}
|
	variable_or_constant_typecast SUB_OP arithmetic_expression
	{

	}
|
	variable_or_constant_typecast MULT_OP arithmetic_expression
	{

	}
|
	variable_or_constant_typecast DIV_OP arithmetic_expression
	{

	}
|
	variable_or_constant_typecast ADD_OP variable_or_constant_typecast
	{
		/* 
...
|
	variable_or_constant_typecast SUB_OP variable_or_constant_typecast
	{
		/* 
		$$ = new Relational_Expr_Ast($1, VAR, NULL);
		*/
...
|
	variable_or_constant_typecast MULT_OP variable_or_constant_typecast
	{
		/* 
		$$ = new Relational_Expr_Ast($1, VAR, NULL);
		*/
...
|
	variable_or_constant_typecast DIV_OP variable_or_constant_typecast
	{
		/* 
		$$ = new Relational_Expr_Ast($1, VAR, NULL);
		*/
